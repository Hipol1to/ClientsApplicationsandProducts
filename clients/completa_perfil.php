                ...
                <form action="complete_profile_process.php" method="post" enctype="multipart/form-data">
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                <label for="clienteCuentaBancaria">Telefono celular:</label>
                <input type="number" class="form-control" id="clienteCelular" name="clienteCelular" pattern="\d*" maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
            </div>
            <div class="form-group">
