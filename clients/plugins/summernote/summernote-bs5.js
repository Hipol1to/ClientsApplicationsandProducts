            ...
            value: function createVideoNode(url) {
              ...
              if (ytMatch && ytMatch[1].length === 11) {
                ...
                $video = external_jQuery_default()("<iframe>")
                  ...
                  .attr(
                    "src",
                    "http://drive.google.com/file/d/" + gdMatch[1] + "/preview"
                  )
                  .attr("width", "640")
                  .attr("height", "480");
                ...
                $video = external_jQuery_default()("<iframe>")
                  ...
                  .attr(
                    "src",
                    "http://instagram.com/p/" + igMatch[1] + "/embed/"
                  )
                  .attr("width", "612")
                  .attr("height", "710")
                  .attr("scrolling", "no")
                ...
                $video = external_jQuery_default()("<iframe>")
                  ...
                  .attr(
                    "src",
                    "http://www.facebook.com/plugins/video.php?href=" +
        ...
        HelpDialog_createClass(HelpDialog, [
          {
            ...
            value: function initialize() {
              ...
              var body = [
                ...
                '<a href="http://github.com/summernote/summernote" target="_blank" rel="noopener noreferrer">Project</a> · ',
                '<a href="http://github.com/summernote/summernote/issues" target="_blank" rel="noopener noreferrer">Issues</a>',
                "</p>",
              ].join("");
              this.$dialog = this.ui
                .dialog({
