...
(function (global, factory) {
  ...
  const getCloseButton = () => elementByClass(swalClasses.close); // http://github.com/jkup/focusable/blob/master/index.js
  ...
  const isScrollable = (elem) => !!(elem.scrollHeight > elem.clientHeight); // borrowed from http://stackoverflow.com/a/46352119
  ...
  renderInputType.textarea = (textarea, params) => {
    ...
    const getMargin = (el) =>
      ...
      parseInt(window.getComputedStyle(el).marginRight); // http://github.com/sweetalert2/sweetalert2/issues/2291
  ...
  const addClasses$1 = (container, popup, params) => {
    addClass(container, params.showClass.backdrop); // this workaround with opacity is needed for http://github.com/sweetalert2/sweetalert2/issues/2059
