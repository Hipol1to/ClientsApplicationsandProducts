...
<div class="content-wrapper">
  ...
  <div class="modal-dialog modal-lg">
    ...
    <small class="text-danger" id="montoError" style="display: none;">Solo se aceptan numeros decimales de 2 digitos (por ejemplo, 5.35)</small>
</div>
...
<div class="modal-dialog">
    ...
    <form id="editFormParticipacion">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="editIdInversion" name="editIdInversion">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="editFechaInicioParticipacion" name="editFechaInicioParticipacion">
        </div>
        <div class="form-group">
            <label for="editFechaFinParticipacion">Fecha Fin Participación:</label>
            <input type="text" class="form-control" id="editFechaFinParticipacion" name="editFechaFinParticipacion">
        </div>
    </form>
</div>
