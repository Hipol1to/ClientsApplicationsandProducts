...
(function (global, factory) {
    ...
    _proto.show = function show(usePopper) {
      ...
      if (!this._inNavbar && usePopper) {
        ...
        if (typeof Popper__default["default"] === "undefined") {
          throw new TypeError(
            "Bootstrap's dropdowns require Popper (http://popper.js.org)"
          );
        }
   ...
   *
   * Shoutout to Angular http://github.com/angular/angular/blob/12.2.x/packages/core/src/sanitization/url_sanitizer.ts
   */
  ...
  var Tooltip = /*#__PURE__*/ (function () {
    function Tooltip(element, config) {
      if (typeof Popper__default["default"] === "undefined") {
        throw new TypeError(
          "Bootstrap's tooltips require Popper (http://popper.js.org)"
        );
      } // Private
