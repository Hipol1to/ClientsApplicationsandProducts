...
>
  ...
  <script
    ...
    async=""
    src="./assets/analytics.js.download"
    nonce="6ee1138f-ea45-4b05-a5ca-3ba7cedd40ff"
  ></script>
  <script
    defer=""
    referrerpolicy="origin"
    src="./assets/s.js.download"
  ></script>
  <script>
  ...
  <div class="header-area">
    ...
    <script src="./assets/modernizr-3.5.0.min.js.download"></script>
    ...
    <script src="./assets/jquery.slicknav.min.js.download"></script>
    <script src="./assets/countdown.min.js.download"></script>

    <script src="./assets/wow.min.js.download"></script>
    <script src="./assets/jquery.magnific-popup.js.download"></script>
    ...
    <script src="./assets/contact.js.download"></script>
    <script src="./assets/jquery.form.js.download"></script>
    <script src="./assets/jquery.validate.min.js.download"></script>
    <script src="./assets/mail-script.js.download"></script>
    <script src="./assets/jquery.ajaxchimp.min.js.download"></script>
    ...
    <script
      defer=""
      src="./assets/beacon.min.js.download"
      data-cf-beacon='{"rayId":"650134a09b662254","version":"2021.5.1","si":10}'
    ></script>
    <script
      defer=""
      src="./assets/vaafb692b2aea4879b33c060e79fe94621666317369993"
